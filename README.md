...
I'm a passionate developer building practical software across AI, security, productivity tools, Bitcoin, and open-source infrastructure.

## Current Work

- **[Vibooks](https://vibooks.ai)**  
  Professional bookkeeping software and services for small businesses and bookkeeping firms. Vibooks is local-first, API-driven, and built for AI-assisted bookkeeping workflows: source evidence, posting, reconciliation, reporting, accountant handoff, and optional QuickBooks Online delivery.
